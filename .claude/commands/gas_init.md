Read and internalize this codebase context so you can work effectively without re-exploring.

## What This Is

A **2D gas simulator** for testing robot exploration strategies, running in the browser. A robot navigates a map, follows routes, and detects/chases gas plumes.
